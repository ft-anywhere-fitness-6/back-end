...
/**
  ...
  This endpoint is RESTRICTED: only authenticated users with role 'admin' should have access.
 ...
 */
router.get("/:user_id", restricted, only('instructor'), (req, res, next) => { // done for you
